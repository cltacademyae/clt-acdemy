  ...
  return (
    <div className="w-screen flex items-center  justify-center px-3">
      <div className="w-full min-h-[30vh] py-10 md:flex-row flex-col bg-primary rounded-lg md:px-25 flex items-center justify-between">
        {/* A tagline, not a section heading. As an <h2> it was 98 characters
            long and repeated on eleven pages, which is what a crawl reports as
            a duplicate, over-long heading. The banner needs no heading of its
            own — the styling is unchanged. */}
        <p className="text-white md:w-1/2 w-[90%] text-4xl font-bold">
